    ...
    <>
        ...
        <div className='flex bg-gray-900 text-white justify-around py-20' >
            ...
            <div>
                ...
                <p><Link to={'Examudates'}>Exam Udates</Link></p>
                <p><Link to={'Requestforspecimen'}>Request for Specimen</Link></p>
                <p><Link to={'Trackyourorder'}>Track Your Order</Link></p>
                <p><Link to={'Connectus'}>Connect Us</Link></p>
            ...
            <div>
                ...
                <p><Link to={'Viewcart'}>View Cart</Link></p>
            ...
            <div>
                ...
                <p><Link to={'Viewcart'}>Shipping, Returns & Cancellation</Link></p>
                </div>
            </div>
            <div>

                <div>
                    <h1 className='mb-8 text-blue-400 font-semibold'>Corporate Office :-</h1>
                    <p> 45,2nd floor , Maharishi Dayanand Marg, Corncer Market, Malviya <br />
                    Nagar, New Delhi
                    </p>
                </div>
                <div>
                    <h1 className='mt-8 text-blue-400 font-semibold'>Registerd office:-</h1>
                    <p> B-32, BASEMENT , SHIVALIK, MALVIYA NAGAR,NEW DELHI,DELHI, 110017</p>
