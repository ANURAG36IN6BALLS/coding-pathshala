      ...
      <div className="font-sans ">
        <header>
          ...
          <div className="w-[28%] m-auto hidden md:block">
            <div className=" relative h-12 p-[8px]  m-2 border-[4px] rounded-3xl border-orange-400">
              <input
                type="search"
              ...
              <IoSearch
                ...
                className=" h-[30px] p-[3px] w-[45px]  text-[5px] bg-green-200 rounded-3xl absolute top-[10px] right-2  "
              />
