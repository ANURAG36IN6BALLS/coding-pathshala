    ...
    <>
      <div className="font-sans">
        <header>
          ...
          <div
            className="flex text-white space-x-[150px] items-center bg-black h-[60px] font-semibold text-sm cursor-pointer justify-center
         "
          >
            ...
            >
              <p className="hover:bg-green-500 px-2 rounded-lg">Grow With Us</p>
              <IoIosArrowDown />
              <div
